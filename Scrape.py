...
class Scrape:
    ...
    def scrape(self, url, driver):
        try:
            ...
            infos = container.find_elements(By.XPATH,
                                            "//div[@class='form-group informationblockheight col-md-4 col-sm-12 ng-binding']")
            information["address"] = infos[0].text
            information["price"] = infos[1].text.split('$')[1].replace(',', '')
            information["listingNumber"] = container.find_element(By.XPATH,
                                                                  "//div[@class='informationblockheight form-group col-md-4 col-sm-12 ng-binding']").text
